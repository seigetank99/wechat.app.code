...
Calendar.prototype = {
    ...
    init: function () {
        ...
        el.on("click", ".calendar-cell", function (e) {
            ...
            if (opts.mode == "year") {
                ...
                if (opts.cellClick) {
                    opts.cellClick.call(me, cellDate)
                    //opts.cellClick.call(me, viewData[date])
                }
            }
        })
        ...
        el.on("click", ".calendar-year-select", function (e) {
            ...
            //创建下拉数据
            var yearText = new Date().getFullYear();//opts.newDate.getFullYear();
            var s = '';
            for (var i = 0; i < 5; i++) {
                if (i == 0) {
                ...
                s += '<span class="year-check">' + (yearText - i) + '</span>'
                s += '<span >年</span>'
                s += '</li>'
            }
        ...
        el.on("click", ".month-item", function (e) {
            ...
            if(monthNum == 1){
                var data = [
                    ...
                    { startDate: "2019-1-02", name: "222" },
                    { startDate: "2019-1-03", name: "333" },
                    { startDate: "2019-1-10", name: "444" }
                ]
    ...
    getViewDate: function (viewDate) {
        ...
        var viewData = {},
            ...
            modeMonth = null;
        if (mode == "month") { modeMonth = viewDate.getMonth() + 1 };
    ...
    _refreshCalendar: function (newDate) {
        ...
        for (var i = 0; i < 6; i++) {
            ...
            for (var l = 0; l < 7; l++) {
                ...
                else if (renderDate.toLocaleDateString() == nowDate) {
